      ...
      additional_info: [
        {
          ...
          prop_value: waterFilterModelNumber,
        },
        {
          property_id: 2,
          prop_value: airFilterModelNumber,
        },
        {
          property_id: 3,
          ...
          <div className="column">
            ...
            <div className="column">
              <input
                ...
                required
                onChange={(event) =>
                  setwaterFilterModelNumber(event.target.value)
                }
              />
            </div>
            <div className="column">
              <input
                ...
                required
                onChange={(event) =>
                  setairFilterModelNumber(event.target.value)
                }
              />
            </div>
            <div className="column">
